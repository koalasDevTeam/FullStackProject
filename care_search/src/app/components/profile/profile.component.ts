...
export class ProfileComponent implements OnInit {
 ...
 helpersArr = [
    ...
    },
    {
      ...
      info: "Cuidadora experimentada con mas de 8 años de experiencia en este sector. Ofrezco los mejores cuidados y atenciones como interna. Preparaba la cena, los llevaba de paseo y ayudaba a prepararse para la hora de dormir. Apoyé a los ancianos en labores básicas de aseo y movilidad.",
      location:"Las Palmas",
      score: 4.8,
       price:"1200€/Mes",
    },
